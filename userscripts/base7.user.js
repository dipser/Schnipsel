...
`;
    ...
    var checkin_checkout = function(t) {
        var months = {'Jan':'01', 'Feb':'02', 'Mär':'03', 'Mar':'03', 'Apr':'04', 'Mai':'05', 'May':'05', 'Jun':'06', 'Jul':'07', 'Aug':'08', 'Sep':'09', 'Okt':'10', 'Oct':'10', 'Nov':'11', 'Dez':'12'};
    ...
    $(document).arrive('#sup-content > #roomkeeping', {existing:true}, function(newElem) {
